...
<details>
  ...
  * Data para entrega final do projeto: `25/04/2023 14:00`.
...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-030-a-project-trybetunes.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-030-a-project-trybetunes`
  ...
  - Agora crie uma branch à qual você vai submeter os `commits` do seu projeto
    ...
    - Exemplo: `git checkout -b joaozinho-sd-030-a-project-trybetunes`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-sd-030-a-project-trybetunes`

  6. Crie um novo `Pull Request` _(PR)_

  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-030-a-project-trybetunes/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-030-a-project-trybetunes/pulls) e confira que o seu _Pull Request_ está criado
...
[FORMULÁRIO DE AVALIAÇÃO DE PROJETO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH30-A&template=betrybe/sd-0x-project-trybetunes)
